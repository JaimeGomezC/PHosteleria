        ...
        $sql = "
            ...
            BEGIN
                ...
                IF plazas_ocupadas >= plazas_totales THEN
                    RETURN CONCAT('Todas las plazas reservadas. Plazas totales: ', plazas_totales, ', plazas ocupadas: ', plazas_ocupadas, ', plazas disponibles: ', plazas_disponibles, ', id_turno: ', JSON_EXTRACT(json_params, '$.id_turno'));
                END IF;
            
                -- Verificar si el número de plazas disponibles después de restar los comensales de la reserva
                ...
                VALUES (
                    JSON_EXTRACT(json_params, '$.nombre'),
                    JSON_EXTRACT(json_params, '$.apellido1'),
                    JSON_EXTRACT(json_params, '$.apellido2'),
                    JSON_EXTRACT(json_params, '$.email'),
                    JSON_EXTRACT(json_params, '$.telefono'),
                    JSON_EXTRACT(json_params, '$.observaciones_cliente'),
                    JSON_EXTRACT(json_params, '$.fecha')
                );
                ...
                VALUES (
                    id_cliente,
                    JSON_EXTRACT(json_params, '$.id_turno'),
                    JSON_EXTRACT(json_params, '$.observaciones_reserva'),
                    JSON_EXTRACT(json_params, '$.fecha'),
                    JSON_EXTRACT(json_params, '$.num_comensales'),
                    JSON_EXTRACT(json_params, '$.forma_pago'),
                    JSON_EXTRACT(json_params, '$.precio_total'),
                    JSON_EXTRACT(json_params, '$.pagado_base'),
                    JSON_EXTRACT(json_params, '$.pagado_total'),
                    v_codigo,
                    JSON_EXTRACT(json_params, '$.producto_extra'),
                    JSON_EXTRACT(json_params, '$.estado')
                );
            
                RETURN CONCAT('Plazas totales: ', plazas_totales, ', plazas ocupadas: ', plazas_ocupadas, ', plazas disponibles: ', plazas_disponibles, ', id_turno: ', JSON_EXTRACT(json_params, '$.id_turno'));
            END
        ";
        DB::unprepared($sql);
    }
